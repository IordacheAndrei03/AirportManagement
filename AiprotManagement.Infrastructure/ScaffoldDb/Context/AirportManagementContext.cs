...
namespace AirprotManagement.Infrastructure.ScaffoldDb.Context;
...
//        => optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=AirportManagement;Trusted_Connection=True;MultipleActiveResultSets=True");
