...
{
    public class FlightsControllerDeleteTests : FlightsControllerTestBase
    {
        [Fact]
        public async Task Delete_WhenOk_Returns200_WithResultInBody()
        {
            _flightService.Setup(s => s.DeleteAsync(10))
            ...
            _flightService.Verify(s => s.DeleteAsync(10), Times.Once);
        }
