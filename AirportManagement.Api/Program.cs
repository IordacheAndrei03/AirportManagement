...
using AirportManagement.Application.Services.ImportServices;
...
builder.Services.AddScoped<IScheduleImportParser, ScheduleImportParser>();
builder.Services.AddScoped<IScheduleImportRowProcessor, ScheduleImportRowProcessor>();
